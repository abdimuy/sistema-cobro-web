...
const FRIENDLY_MESSAGES: Record<string, string> = {
  ...
  reactivacion_conversacion_no_encontrada: "la conversación no existe",
  reactivacion_no_hay_borrador_pendiente: "no hay un borrador pendiente para este cliente",
  reactivacion_cliente_sin_datos_contacto: "el cliente no tiene datos de contacto",
  reactivacion_texto_editado_vacio: "el texto editado no puede estar vacío",
  reactivacion_intencion_vacia: "la intención dictada no puede estar vacía",
  reactivacion_mensaje_entrante_vacio: "el mensaje entrante no puede estar vacío",
};
