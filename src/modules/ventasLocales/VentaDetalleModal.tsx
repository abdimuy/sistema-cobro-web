            ...
            {activeTab === "info" && (
              <div className="space-y-6 animate-fade-in">
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 rounded-xl p-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div className="bg-card rounded-lg p-4">
                      ...
                      {venta.FREC_PAGO ? (
                        <span className="inline-block mt-2 px-3 py-1 bg-blue-100 dark:bg-blue-950/30 text-blue-700 dark:text-blue-400 rounded-full text-sm font-medium">
                          {venta.FREC_PAGO}
                        </span>
                      ) : (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  {venta.NOTA && (
                    <div className="bg-yellow-50 dark:bg-yellow-950/20 rounded-xl p-6">
                      <h3 className="text-lg font-semibold text-foreground mb-4 flex items-center gap-2">
                              ...
                              <div className="flex items-center justify-between">
                                <div className="flex-1">
                                  ...
                                  <div className="flex items-center gap-4 mt-2">
                                    ...
                                    <span className="px-3 py-1 bg-blue-100 dark:bg-blue-950/30 text-blue-700 dark:text-blue-400 rounded-full text-sm font-medium">
