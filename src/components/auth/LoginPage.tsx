...
const LoginPage: React.FC = () => {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      const redirectRoute = getFirstAvailableRoute();
      navigate(redirectRoute, { replace: true });
    }
  }, [isAuthenticated, navigate, getFirstAvailableRoute]);
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-card rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-2">Sistema Muebles San Pablo - Acceso Administrativo</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-3 border border-border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors bg-muted focus:bg-background text-foreground"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-10 py-3 border border-border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors bg-muted focus:bg-background text-foreground"
                  placeholder="••••••••"
                  required
                />
                <button
                ...
                >
                  {showPassword ? (
                    <svg className="h-5 w-5 text-muted-foreground hover:text-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L8.464 8.464m1.414 1.414L15.12 15.12m-4.242-4.242L15.12 15.12m0 0l1.415 1.414M15.12 15.12l-1.414-1.414" />
                    </svg>
                  ) : (
                    <svg className="h-5 w-5 text-muted-foreground hover:text-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
